 ...
 */
export async function initializeStablecoin(connection, payer, authority, mint, freezeAuthority, name, symbol, uri, decimals) {
 ...
 */
export async function mint(connection, payer, mint, to, amount, mintAuthority, freezeAuthority) {
 ...
 */
export async function freezeAccount(connection, owner, freezeAuthority, mint, account) {
...
export async function thawAccount(connection, owner, freezeAuthority, mint, account) {
 ...
 */
export async function addToBlacklist(connection, payer, authority, mint, target) {
...
export async function removeFromBlacklist(connection, payer, authority, target) {
 ...
 */
export async function seize(connection, authority, mint, fromAccount, toAccount) {
 ...
 */
export async function getTokenBalance(connection, mint, owner) {
    try {
